# Listas / Vetpres
lista=[ 'Maria', 'Guilherme', 'José', 'Carlos']
listaa=['José', 'Pedro']
...
lista.remove('Guilherme')  # Remover um item de valor determinado
...
print(lista.index('Guilherme')) # Índice na qual o valor informado está na lista.
